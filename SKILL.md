...
4. Don't fall back to WebSearch unless a company's documented method starts failing outright (e.g. the API starts 404ing/500ing) — and if you do, treat any result through the "Only trust the company's own site" filter above before including it.
